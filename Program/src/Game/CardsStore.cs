...
namespace GameProgram
{
    public static class CardsStore
    {
        ...
        public static Card HealCard = new Card("Heal", ListerE(ListerO(Self()), ListerP(Heal(15))), new CodeLocation());


        //Decks
        public static List<Card> BasicDeck = new List<Card>() { FireballCard, LightningCard, HealCard };
